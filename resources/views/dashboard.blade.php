...
<body>
    <div class="row mb-5 justify-content-center align-items-center">
        @if ($user->name)
            ...
            <div class="row p-1">
                <form action="/logout" method="GET"><button class="btn btn-danger w-100"
                        id="login_button" type="submit">Log
                        Out</button></form>
            </div>
        @else
            <div>
                <form action="/login" method="GET"><button class="btn btn-danger" id="login_button" type="submit">Log
                        In</button></form>
            </div>
        @endif
    ...
    <div class="container mt-5" id="container">
        <div class="row mb-5 justify-content-center align-items-center">
            <h1 class="col-10" style="text-align: center; font-weight: bold;">
        ...
        <form id="task-form" class="mb-3">
            <div class="input-group">
                <input type="text" id="task-input" class="form-control" placeholder="Enter your task" />
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" id="custom-modal-button" data-bs-dismiss="modal">
                        Confirm
                    </button>
                </div>
            </div>
